...
const InventoryManagement = lazy(() => import('../pages/InventoryManagement.js'));
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            element: <PermissionRoute permission="Inventory.View" />,
            children: [
              { path: '/inventory', element: <SuspenseLayout><InventoryManagement /></SuspenseLayout> },
            ],
          },
          {
